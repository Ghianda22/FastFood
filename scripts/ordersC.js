...
//user.orders = array with all orders ids
            ...
            /* DISHES INFO */
            {
                for(const id of order.dishIds){
                    for(const dish of dishes){
                        if(id == dish.id){
                            if(document.getElementById(dishUl.id + "-" + dish.id) == null){
                                showDish(dishUl.id,dish);
                            }else{
                                let c = document.getElementById(dishUl.id + "-" + dish.id + "-data-quantity-spanQ").innerHTML;
                                c++;
                                document.getElementById(dishUl.id + "-" + dish.id + "-data-quantity-spanQ").innerHTML = c;
                            }
                        }
                    }
                }
